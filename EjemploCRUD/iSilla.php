...
<html lang="en">
  <head>
    ...
    <script type="text/javascript">
      function elimina(id_silla){
			$.ajax({
			    type: "POST",
			    url: "controllers/eSilla.php",
			    data: "id_silla="+id_silla,
	...
	function edit(id_silla){
		document.getElementById("codigo").value=id_silla;
    	}
...
alert(html+"info");
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="codigo" placeholder="Código de la silla" required />
    </div>
  </div>
